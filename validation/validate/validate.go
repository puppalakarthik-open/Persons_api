...
func Valid(c *gin.Context) (models.Person,error) {
	...
	rules := govalidator.MapData{
		...
		"blood_type": []string{"required", "min:1", "max:10"},
	...
	messages := govalidator.MapData{
		...
		"blood_type": []string{"required:please enter the blood type", "min:minimum 2 character required", "max:Takes upto3 characters only"},
